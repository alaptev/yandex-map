...
function init(ymaps) {
    ...
    var myMap = new ymaps.Map("map", {
        center: [55.76070753602857, 37.57721569716090],
        zoom: 18
    }, {
    ...
    var firstAnimatedLine = new ymaps.AnimatedLine([
        ...
        [55.76070753602857, 37.57721569716090],
        [55.76099639684956, 37.57732298552150],
        [55.76091650035293, 37.57819287043990],
        [55.76091952506843, 37.57851473552170],
        [55.76098304403938, 37.57876954537813],
        [55.76109495816394, 37.57893852454606],
        [55.76122432960969, 37.57853503897966]
    ], {}, {
        // Задаем цвет.
        strokeColor: "#ED4543",
        // Задаем ширину линии.
